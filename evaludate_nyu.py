...
if __name__ == '__main__':
    ...
    parser.add_argument('--filenames_file_eval', default='/home/chenwu/DisDepth/dataset/splits/nyu/val.txt', type=str)
    ...
    valloader = get_nyud_loader(data_dir_root=args.filenames_file_eval)

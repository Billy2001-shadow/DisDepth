...
parser.add_argument('--data_path', default='/data2/cw/sync/', type=str) # 训练集图片根目录
parser.add_argument('--gt_path', default='/data2/cw/sync/', type=str)   # 训练集GT根目录
parser.add_argument('--data_path_val', default='/data2/cw/nyu_test/', type=str) # 训练集图片根目录
parser.add_argument('--gt_path_val', default='/data2/cw/nyu_test/', type=str)   # 训练集GT根目录
